        ...
        <!-- MIDDLE BOXES -->
        <div id="boxes">
            <h1 class="element-invisible">Middle Boxes</h1>
            <ul>
                <!-- QUICK LINKS -->
                <li>
                    <div id="box1">
                        ...
                        <ul>
                            <li><a href="<?= base_url('associates-and-volunteers/open-positions.html') ?>">Open Positions</a></li>
                            <li><a href="<?= base_url('associates-and-volunteers/submit-resume.html') ?>">Submit Resume</a></li>
                            <li><a href="<?= base_url('it-services/request-information-technology-services.html') ?>">Apply for Services</a></li>
                        </ul>
                     </div>
                </li>
                <!-- GOOGLE ADSENSE -->
                <li>
                    <div id="box2">
                        <h2 class="element-invisible">Google Ads</h2>
                        <!-- Front Page -->
                        <ins class="adsbygoogle"
                             style="display:inline-block;width:315px;height:250px"
                             data-ad-client="ca-pub-6289886238351946"
                             data-ad-slot="2381169519"></ins>
                        <script>
                ...
                <li>
                    <div id="box3">
                        <h2 class="element-invisible">Twitter Feed</h2>
                        <a class="twitter-timeline" href="https://twitter.com/McGrathSolution" data-widget-id="387363646474428416">Tweets by @McGrathSolution</a>
                        <script>
